...
@Component({
  selector: 'filtro-servicos',
  templateUrl: './filtroServicos.component.html',
  styleUrls: ['./filtroServicos.component.css']
})

export class FiltroServicosComponent implements OnInit {
